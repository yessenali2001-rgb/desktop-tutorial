...
// Сначала зарубежные вузы и стипендии (главная цель класса), потом вузы Казахстана как запасной вариант.
// Сроки и условия — «обычно»: их нужно сверять с сайтом программы каждый год.
// Баллы на грант — примерный ориентир: их нужно проверять каждый год и можно менять прямо в таблице.
const DEFAULT_UNIVERSITIES = [
  ["Университеты США (Common App)", "Разные города", "США", "Все направления", "Common App: оценки 9–12 кл., эссе, рекомендации учителей, активности, IELTS/TOEFL/Duolingo, SAT (часть вузов — по желанию)", "Частичная (в части вузов — полная финпомощь)", "Early — 1 ноября, Regular — 1–15 января (в 11 классе)", "", 7.0, "Английский", "commonapp.org", "Сильнее всего ценят активности, эссе и олимпиады"],
  ["NYU Abu Dhabi", "Абу-Даби", "ОАЭ", "Все направления", "Common App + собеседование, IELTS/TOEFL, SAT по желанию", "Полная (по потребности семьи)", "Ноябрь (Early) или январь (Regular)", "", 7.0, "Английский", "nyuad.nyu.edu", "Конкурс очень высокий"],
  ["Университеты Канады", "Торонто, Ванкувер и др.", "Канада", "Все направления", "Заявка в вуз: оценки, IELTS, эссе; стипендии Lester B. Pearson (Торонто), UBC International Scholars", "Частичная (полные — редкие именные стипендии)", "Ноябрь–январь (в 11 классе)", "", 6.5, "Английский", "educanada.ca", "Полную стипендию дают немногим, подавайте рано"],
  ["Великобритания (UCAS)", "Разные города", "Великобритания", "Все направления", "UCAS: личное эссе, рекомендация, IELTS; после 11 класса обычно нужен Foundation year", "Платно (стипендии бакалавриата редкие)", "Конец января (Оксфорд, Кембридж, медицина — середина октября)", "", 6.5, "Английский", "ucas.com", "Дорого, без стипендии не подходит"],
  ["Германия (государственные вузы)", "Разные города", "Германия", "Инженерия и технологии; IT и программирование; Экономика, финансы, бизнес; Биология, химия, экология; Архитектура и дизайн; Медицина", "Аттестат 11 кл. обычно не даёт прямого поступления: Studienkolleg или 1–2 курса вуза в Казахстане; немецкий B2–C1 или IELTS для англ. программ", "Бесплатно или низкая плата (только семестровый взнос)", "15 июля (зимний семестр), 15 января (летний)", "", 6.5, "Немецкий, английский", "daad.de", "Нужны деньги на жизнь; блок-счёт для визы"],
  ["Чехия (обучение на чешском)", "Прага, Брно и др.", "Чехия", "Все направления", "Год подготовки чешского языка, потом экзамены в вуз", "Бесплатно на чешском языке", "Февраль–апрель", "", "", "Чешский", "studyin.cz", "Платить только за подготовительный год и жизнь"],
  ["Италия (стипендия DSU)", "Милан, Турин, Падуя и др.", "Италия", "Все направления", "Заявка на англ. программу, IELTS, иногда SAT или тест вуза; медицина — экзамен IMAT", "Стипендия по доходу семьи (DSU): бесплатная учёба и деньги на жизнь", "Январь–май (у каждого вуза свои сроки)", "", 6.0, "Английский, итальянский", "studyinitaly.esteri.it", "Нужны документы о доходах семьи"],
  ["Stipendium Hungaricum (вузы Венгрии)", "Будапешт и др.", "Венгрия", "Все направления", "Онлайн-заявка, IELTS, вступительный экзамен или собеседование вуза", "Полная стипендия", "Ноябрь–январь", "", 6.0, "Английский", "stipendiumhungaricum.hu", "Казахстан участвует в программе"],
  ["Türkiye Bursları (вузы Турции)", "Разные города", "Турция", "Все направления", "Онлайн-заявка: оценки, мотивационное письмо, собеседование", "Полная стипендия", "Январь–февраль", "", "", "Турецкий (год языка), английский", "turkiyeburslari.gov.tr", "Полная стипендия государства Турции"],
  ["METU (ODTÜ)", "Анкара", "Турция", "IT и программирование; Инженерия и технологии; Архитектура и дизайн; Экономика, финансы, бизнес; Международные отношения", "SAT или YÖS + IELTS/TOEFL", "Частичная, низкая плата", "Весна (уточните на сайте)", "", 6.5, "Английский", "metu.edu.tr", "Один из лучших технических вузов Турции"],
  ["Bilkent University", "Анкара", "Турция", "IT и программирование; Инженерия и технологии; Экономика, финансы, бизнес; Международные отношения; Архитектура и дизайн", "SAT + IELTS/TOEFL", "Частичная и полная стипендия (по баллам SAT)", "Весна (уточните на сайте)", "", 6.5, "Английский", "bilkent.edu.tr", "Стипендия зависит от SAT"],
  ["KAIST", "Тэджон", "Корея", "IT и программирование; Инженерия и технологии; Биология, химия, экология", "Онлайн-заявка: оценки, рекомендации, IELTS/TOEFL; олимпиады очень помогают", "Полная стипендия (обычно для принятых иностранцев)", "Осень–зима (уточните на сайте)", "", 6.5, "Английский", "kaist.ac.kr", "Сильная математика и физика"],
  ["GKS (вузы Кореи)", "Разные города", "Корея", "Все направления", "Заявка через посольство Кореи: оценки, эссе, рекомендации, IELTS или TOPIK", "Полная стипендия", "Февраль–март", "", 5.5, "Корейский (год языка), английский", "studyinkorea.go.kr", "Полная стипендия правительства Кореи"],
  ["MEXT (вузы Японии)", "Разные города", "Япония", "Все направления", "Через посольство Японии: письменные экзамены (математика, английский и др.) и собеседование", "Полная стипендия", "Апрель–май", "", "", "Японский (год языка), английский", "studyinjapan.go.jp", "Экзамены по математике и естественным наукам"],
  ["Chinese Government Scholarship (вузы Китая)", "Разные города", "Китай", "Все направления", "Заявка через посольство Китая или вуз", "Полная стипендия", "Январь–апрель", "", 5.5, "Китайский (год языка), английский", "campuschina.org", "Полная стипендия правительства Китая"],
  ["Россия (квота Россотрудничества)", "Разные города", "Россия", "Все направления", "Заявка на квоту онлайн, собеседование или олимпиада", "Бесплатно (квота)", "Октябрь–январь", "", "", "Русский", "education-in-russia.com", "Бесплатная учёба по квоте"],
  ["Назарбаев Университет (NU)", "Астана", "Казахстан", "IT и программирование; Инженерия и технологии; Медицина; Экономика, финансы, бизнес; Биология, химия, экология; Международные отношения", "NUET + IELTS (ЕНТ не нужен). Слабее — через Foundation (NUFYP)", "Госгрант", "Январь–май", "", 6.5, "Английский", "nu.edu.kz", "Обучение как за рубежом, на английском"],
  ["КБТУ", "Алматы", "Казахстан", "IT и программирование; Инженерия и технологии; Экономика, финансы, бизнес; Биология, химия, экология", "ЕНТ (2 профильных предмета по специальности) + английский", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 115, "", "Английский", "kbtu.edu.kz", "Сильные IT и нефтегаз"],
  ["Astana IT University (AITU)", "Астана", "Казахстан", "IT и программирование", "ЕНТ (2 профильных предмета по специальности)", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 105, "", "Английский", "astanait.edu.kz", "Только IT"],
  ["SDU University", "Каскелен (Алматы)", "Казахстан", "IT и программирование; Инженерия и технологии; Экономика, финансы, бизнес; Педагогика; Филология и языки; Право", "ЕНТ (2 профильных предмета по специальности) + английский", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 105, "", "Английский, казахский", "sdu.edu.kz", "Много выпускников БИЛ"],
  ["КазНУ им. аль-Фараби", "Алматы", "Казахстан", "IT и программирование; Инженерия и технологии; Экономика, финансы, бизнес; Биология, химия, экология; Право; Международные отношения; Филология и языки; Журналистика и медиа; Педагогика; Психология; Туризм и сервис", "ЕНТ (2 профильных предмета по специальности)", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 110, "", "Казахский, русский, английский", "kaznu.kz", "Крупнейший классический университет"],
  ["ЕНУ им. Л.Н. Гумилёва", "Астана", "Казахстан", "IT и программирование; Инженерия и технологии; Архитектура и дизайн; Экономика, финансы, бизнес; Биология, химия, экология; Право; Международные отношения; Филология и языки; Журналистика и медиа; Педагогика; Психология; Туризм и сервис", "ЕНТ (2 профильных предмета по специальности)", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 105, "", "Казахский, русский, английский", "enu.kz", "Классический университет"],
  ["Satbayev University", "Алматы", "Казахстан", "Инженерия и технологии; IT и программирование; Архитектура и дизайн", "ЕНТ (2 профильных предмета по специальности)", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 100, "", "Казахский, русский, английский", "satbayev.university", "Инженерия, горное дело, геология"],
  ["КазНМУ им. Асфендиярова", "Алматы", "Казахстан", "Медицина", "ЕНТ (2 профильных предмета по специальности) (биология + химия)", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 120, "", "Казахский, русский, английский", "kaznmu.edu.kz", "Медицина"],
  ["ЗКМУ им. Марата Оспанова", "Актобе", "Казахстан", "Медицина", "ЕНТ (2 профильных предмета по специальности) (биология + химия)", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 110, "", "Казахский, русский, английский", "zkmu.edu.kz", "Медицина, в Актобе"],
  ["Актюбинский региональный университет им. К. Жубанова", "Актобе", "Казахстан", "IT и программирование; Инженерия и технологии; Экономика, финансы, бизнес; Биология, химия, экология; Право; Филология и языки; Педагогика; Психология", "ЕНТ (2 профильных предмета по специальности)", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 85, "", "Казахский, русский", "arsu.kz", "Рядом с домом"],
  ["Университет КИМЭП", "Алматы", "Казахстан", "Экономика, финансы, бизнес; Право; Международные отношения; Журналистика и медиа", "ЕНТ или внутренний экзамен + английский", "Платно, есть скидки и гранты вуза", "ЕНТ весной–летом, гранты — в августе", "", 6.0, "Английский", "kimep.kz", "Обучение на английском"],
  ["Maqsut Narikbayev University (КАЗГЮУ)", "Астана", "Казахстан", "Право; Международные отношения; Экономика, финансы, бизнес", "ЕНТ (2 профильных предмета по специальности)", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 110, "", "Казахский, русский, английский", "mnu.kz", "Сильное право"],
  ["КазУМОиМЯ им. Абылай хана", "Алматы", "Казахстан", "Международные отношения; Филология и языки; Туризм и сервис; Педагогика", "ЕНТ (2 профильных предмета по специальности)", "Госгрант по ЕНТ", "ЕНТ весной–летом, гранты — в августе", 105, "", "Казахский, русский, английский", "ablaikhan.kz", "Языки и международные отношения"],
];
...
const PLAN_FIELDS = ["career", "dir1", "dir2", "where", "country", "city", "grant", "lang", "english", "target", "about"];
const PLAN_MAX = { career: 100, dir1: 80, dir2: 80, where: 40, country: 60, city: 60, grant: 20, lang: 40, english: 40, target: 5, about: 500 };
...
function readPlans_() {
  ...
  rows_("plans", true).forEach((r) => {
    ...
    plan.updated = iso_(r[2 + PLAN_FIELDS.length]);
    res[id] = plan;
  });
  return res;
}
...
function savePlan_(id, plan) {
  ...
  try {
    ...
    if (!sh) {
      ...
      sh.getRange(1, 1, 1, h.length).setValues([h]).setFontWeight("bold").setBackground("#e7ecff");
      sh.setFrozenRows(1);
      sh.getRange(2, 3 + PLAN_FIELDS.length, 200, 1).setNumberFormat("dd.mm.yyyy");
    }
    const values = sh.getDataRange().getValues();
    let rowIndex = -1;
    for (let i = 1; i < values.length; i++) {
  ...
  return rows_("universities", true)
    ...
    .map((r) => ({
      ...
      dirs: String(r[3])
        ...
        .filter(Boolean),
      how: String(r[4]).trim(),
      fund: String(r[5]).trim(),
      deadline: String(r[6]).trim(),
      grantScore: num(r[7]),
      ielts: num(r[8]),
      lang: String(r[9]).trim(),
      site: String(r[10]).trim(),
